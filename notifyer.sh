...
token="5349773691:AAEJuwzz-tswZo6AHlIeXR5b8fwY2tVL1d8"
method="sendMessage"
telegram_user_id="458823093"
message=""
...
if [[ -n "$CICD" && -n "$status_icon" ]] ; then
    ...
    get_CICD_result
    get_correct_message
    curl "$api$token/$method?chat_id=$telegram_user_id&text=$message"
else
